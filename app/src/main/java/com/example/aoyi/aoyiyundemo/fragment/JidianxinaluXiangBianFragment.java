...
public class JidianxinaluXiangBianFragment extends Fragment {
    private String jidianxianluName;
    private String fangzhenName;

    public JidianxinaluXiangBianFragment(String jidianxianluName, String fangzhenName) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.jidianxianlu_xiangbian_fragment,container,false);
        return view;
    }
}
