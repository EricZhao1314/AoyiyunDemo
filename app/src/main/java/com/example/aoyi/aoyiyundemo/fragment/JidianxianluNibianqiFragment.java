...
public class JidianxianluNibianqiFragment extends Fragment {
    private String jidianxianluName;
    private String fangzhenName;

    public JidianxianluNibianqiFragment(String jidianxianluName, String fangzhenName) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.jidianxinalu_nibianqi_fragment,container,false);
        return view;
    }
}
